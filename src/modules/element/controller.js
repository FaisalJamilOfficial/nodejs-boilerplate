 ...
 * @returns {Object} element data
 */
export const addElements = async (elementsArray) => {
 ...
 */
export const updateElements = async (query, elementObj) => {
  if (!query || Object.keys(query).length === 0)
    throw new ErrorHandler("Please enter query!", 400);
 ...
 * @returns {Object} element data
 */
export const deleteElement = async (query) => {
  if (!query || Object.keys(query).length === 0)
    throw new ErrorHandler("Please enter query!", 400);
 ...
 */
export const deleteElements = async (query) => {
  if (!query || Object.keys(query).length === 0)
    throw new ErrorHandler("Please enter query!", 400);
 ...
 */
export const countElements = async (query) => {
  if (!query || Object.keys(query).length === 0)
    throw new ErrorHandler("Please enter query!", 400);
